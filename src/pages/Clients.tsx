...
export default function ClientsPage() {
  ...
  return (
    <div className="px-4 pt-5 pb-4 lg:px-6 lg:pt-6">
      {/* Header */}
      <div className="flex items-center justify-between mb-5">
        <h1 className="font-display text-xl lg:text-2xl text-text-p">Clients</h1>
        <button
      ...
      <div className="sticky top-0 z-10 pb-3 -mx-4 px-4 lg:mx-0 lg:px-0 bg-bg/80 backdrop-blur-xl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-surface border border-border/40 rounded-xl pl-11 pr-4 py-3 text-sm text-text-p placeholder:text-text-t focus:outline-none focus:border-accent/40 transition-colors"
          />
        </div>
      </div>
        ...
        {filtered.map((client, i) => {
          ...
          return (
            <motion.button
              ...
              className="w-full text-left flex items-center gap-4 px-3 py-4 lg:px-4 rounded-xl active:bg-elevated/40 lg:hover:bg-elevated/30 transition-colors cursor-pointer group press-scale"
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-text-p font-medium truncate">{client.name}</span>
                  {stats.upcoming > 0 && (
                    <span className="text-[10px] text-accent bg-accent/8 px-1.5 py-0.5 rounded-md shrink-0">
