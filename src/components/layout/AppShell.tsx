...
export default function AppShell() {
  ...
  return (
    <div className="h-full flex flex-col lg:flex-row">
      ...
      <div
        className={`flex-1 flex flex-col pb-[136px] lg:pb-0 transition-all duration-300 overflow-hidden ${
      ...
      <button
        ...
        className="fixed bottom-[144px] right-5 lg:bottom-8 lg:right-8 w-14 h-14 bg-accent text-bg rounded-xl shadow-lg shadow-glow flex items-center justify-center z-30 cursor-pointer press-scale transition-transform active:shadow-glow-strong"
        title="Quick Booking"
      >
        <Pen size={20} />
      </button>
